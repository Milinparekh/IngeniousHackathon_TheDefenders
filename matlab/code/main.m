...
video=VideoReader('input/project_video.mp4');  %this is the path for the demo video to be processed

numberToExtract=2;


% sp=serial('COM3','BAUD',9600);
...
i=1;
while hasFrame(video) && (i <= 510)  %limitation till 510 frames of the input video only 
